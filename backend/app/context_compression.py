...
Relevant excerpts:"""
    ...
    def compress_simple(
        self, query: str, content: str, max_sentences: int = 10
    ) -> CompressionResult:
    ...
    def compress_with_llm(
        self, query: str, content: str, model: str = None
    ) -> CompressionResult:
    ...
    def compress_chunks(
        self, query: str, chunks: List[str], use_llm: bool = False, max_chunks: int = 5
