...
DOWNLOAD_TASKS=(
    ...
    "download_repo|Helm|https://github.com/helm/helm-www.git|helm|docs|helm-src"
    "download_repo|GCP|https://github.com/GoogleCloudPlatform/python-docs-samples.git|gcp/python-samples"
